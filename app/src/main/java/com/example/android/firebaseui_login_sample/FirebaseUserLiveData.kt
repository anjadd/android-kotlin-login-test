...
class FirebaseUserLiveData : LiveData<FirebaseUser?>() {
    ...
    Use the FirebaseAuth instance instantiated at the beginning of the class to get an entry point
     into the Firebase Authentication SDK the app is using. With an instance of the FirebaseAuth
     class, you can now query for the current user.
    */
    // The value of authStateListener tells you whether there is currently a logged in user in your app or not
